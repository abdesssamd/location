...
class UpdateAssetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $carDetailId = $asset->specifiable_id;

        return [
            'reference' => ['required', 'string', 'max:255', Rule::unique('assets', 'reference')->ignore($asset->id)],
            ...
            'car_detail.license_plate' => ['required', 'string', 'max:255', Rule::unique('car_details', 'license_plate')->ignore($carDetailId)],
